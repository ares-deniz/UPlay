...
const VideoGrid: React.FC<VideoGridProps> = ({ searchQuery, activeCategory }) => {
  const [apiVideos, setApiVideos] = useState<VideoShape[] | null>(null);
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState<string | null>(null);
  const [selected, setSelected] = useState<{ id: string; title?: string; channel?: string } | null>(null);
  ...
  const fallbackVideos = [
    ...
    },
    {
      ...
      duration: '35:17',
      thumbnail: 'https://images.pexels.com/photos/1464375/pexels-photo-1464375.jpeg?auto=compress&cs=tinysrgb&w=800',
      category: 'Music'
    },
    {
      id: 8,
    ...
    },
    {
      ...
      timestamp: '3 days ago',
      duration: '24:12',
      thumbnail: 'https://images.pexels.com/photos/161251/senso-ji-temple-asakusa-tokyo-japan-161251.jpeg?auto=compress&cs=tinysrgb&w=800',
      category: 'Trending'
    },
    {
      id: 10,
      ...
      duration: '31:08',
      thumbnail: 'https://images.pexels.com/photos/276625/pexels-photo-276625.jpeg?auto=compress&cs=tinysrgb&w=800',
      category: 'Home'
    },
    {
      id: 11,
      ...
      timestamp: '5 days ago',
      duration: '42:15',
      thumbnail: 'https://images.pexels.com/photos/40192/jellyfish-water-blue-transparent-40192.jpeg?auto=compress&cs=tinysrgb&w=800',
      category: 'Home'
    },
    {
      id: 12,
      ...
      timestamp: '1 week ago',
      duration: '19:33',
      thumbnail: 'https://images.pexels.com/photos/1076758/pexels-photo-1076758.jpeg?auto=compress&cs=tinysrgb&w=800',
      category: 'Home'
    },
    {
      id: 13,
    ...
    },
    {
      ...
      timestamp: '4 days ago',
      duration: '19:15',
      thumbnail: 'https://images.pexels.com/photos/436413/pexels-photo-436413.jpeg?auto=compress&cs=tinysrgb&w=800',
      category: 'Films'
    },
    {
      id: 18,
  ...
  return (
    <div className="p-4 lg:p-6">
      ...
      />
      {loading && (
        <div className="mb-6 text-gray-400">Loading videos…</div>
      )}
      {error && (
      ...
      {filteredVideos.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500 text-sm mt-2">
            {searchQuery ? 'Try different search terms' : 'No content available for this category'}
          </p>
        </div>
      )}
    </div>
